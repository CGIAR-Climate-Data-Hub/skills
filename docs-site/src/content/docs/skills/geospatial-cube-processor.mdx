...
**Skill file:** `.agents/skills/geospatial-cube-processor/SKILL.md`  
**Raw URL:** `https://raw.githubusercontent.com/CGIAR-Climate-Data-Hub/skills/main/.agents/skills/geospatial-cube-processor/SKILL.md`
