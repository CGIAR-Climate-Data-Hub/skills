...
**Skill file:** `.agents/skills/gcf-pipeline/SKILL.md`  
**Raw URL:** `https://raw.githubusercontent.com/CGIAR-Climate-Data-Hub/skills/main/.agents/skills/gcf-pipeline/SKILL.md`
...
- Translate all MCP tool calls from the colon format in the files (e.g., aggeodata:download_chirps, ag_cube_cm:run_simulation) to the Antigravity slash format (e.g., aggeodata/download_chirps, ag_cube_cm/run_simulation).
