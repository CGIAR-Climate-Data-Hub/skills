...
Complete the [Antigravity setup](../usage/antigravity/) first, then paste the system prompt below. No manual `aggeodata` install needed — the prompt handles it automatically inside the sandbox.
