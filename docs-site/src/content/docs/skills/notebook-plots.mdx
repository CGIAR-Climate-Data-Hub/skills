...
**Type:** Visualization  
**Skill file:** `.agents/skills/notebook-plots/SKILL.md`  
**Raw URL:** `https://raw.githubusercontent.com/CGIAR-Climate-Data-Hub/skills/main/.agents/skills/notebook-plots/SKILL.md`
